...
;_ISR_STARTADDRESS		EQU		0x30000000
...
F_Bit				EQU    0x40 ; when F bit is set, FIQ is disabled
	...
	msr     CPSR_c, #Mode_ABT:OR:F_Bit:OR:I_Bit		; Change to Abort mode
	add		sp, r1, #AbortStack
	
	msr     CPSR_c, #Mode_UNDEF:OR:F_Bit:OR:I_Bit	; Change to Undefined mode
	...
	msr     CPSR_c, #Mode_SVC						; Change to SVC mode
	add		sp, r1, #SVCStack
