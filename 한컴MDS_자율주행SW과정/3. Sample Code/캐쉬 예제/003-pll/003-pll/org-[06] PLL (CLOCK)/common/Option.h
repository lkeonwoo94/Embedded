...
//32MB
// 0x30000000 ~ 0x307fffff : Download Area (8MB) Cacheable
// 0x30800000 ~ 0x31feffff : Non-Cacheable Area
...
#define	_NONCACHE_STARTADDRESS	0x34000000
#endif
