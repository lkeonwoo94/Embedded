...
{
	/* Enable CLC*/
   Mcal_UpdateRegSV((volatile uint32 *)(void *)&STM0_CLC,0x00000100,\
              0xFFFFFFFFU,(uint8)MCAL_TIN_CPU_ENDINIT,0xFFU);
         ...
         void (*Test_Time_CallFnpp)(void))
{
  ...
  if( AlarmId == 0 ) 
  {
   ...
   /*  Enable intr */
   Mcal_UpdateRegSV((volatile uint32 *)(void *)&SRC_STM0SR0,0x2000400U,\
              0x0U,(uint8)MCAL_TIN_NO_ENDINIT,0xFFU);
  ...
  else
  {
   ...
   /*  Enable intr */
   Mcal_UpdateRegSV((volatile uint32 *)(void *)&SRC_STM0SR1,0x2000400U,\
              0x0U,(uint8)MCAL_TIN_NO_ENDINIT,0xFFU);
...
void Test_Time_DeInitAlarm( uint8 AlarmId )
{
  ...
  if( AlarmId == 0 )
  {
   ...
   Mcal_UpdateRegSV((volatile uint32 *)(void *)&SRC_STM0SR0,0x0U,\
              0x400U,(uint8)MCAL_TIN_NO_ENDINIT,0xFFU);
  ...
  if( AlarmId == 1 )
  {
   Mcal_UpdateRegSV((volatile uint32 *)(void *)&SRC_STM0SR1,0x0U,\
              0x400U,(uint8)MCAL_TIN_NO_ENDINIT,0xFFU);
  }
}
#endif
