...
{
  MODULE_GTM.ATOM[ModuleNo].AGC.GLB_CTRL.U |= (unsigned_int)GTM_SET_BIT;
}
...
((*(Ifx_GTM_ATOMx*)(volatile void *)(MODULE_GTM.ATOM)). \
                               ATOM_CH[ModuleNo].CH[ChannelNo].CN0.U)=   \
                                     (unsigned_int)(Cn0Value & GTM_TIMER_MASK);
 ...
 defined in header files*/
{
  ...
  return((uint16)((*(Ifx_GTM_TOMx*)(volatile void *)(MODULE_GTM.TOM)).     \
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
{
  return((uint32)((*(Ifx_GTM_ATOMx*)(volatile void *)(MODULE_GTM.ATOM)). \
       ATOM_CH[ModuleNo].CH[ChannelNo].CN0.U));
 ...
 defined in header files*/
{
  ...
  ((*(Ifx_GTM_TOMx*)(volatile  void *)(MODULE_GTM.TOM)).TOM_CH[ModuleNo].\
                             CH[ChannelNo].CM0.U) =  (unsigned_int)Cm0Value;
 ...
 defined in header files*/
{
  ((*(Ifx_GTM_ATOMx*)(volatile void *)(MODULE_GTM.ATOM)).
                               ATOM_CH[ModuleNo].CH[ChannelNo].CM0.U) =   \
                                     (unsigned_int)(Cm0Value & GTM_TIMER_MASK);
 ...
 defined in header files*/
{
  ((*(Ifx_GTM_ATOMx*)(volatile void *)(MODULE_GTM.ATOM)).ATOM_CH[ModuleNo]. \
               CH[ChannelNo].CM1.U) = (unsigned_int)(Cm1Value & GTM_TIMER_MASK);
}
...
{
  return((uint32)(((*(Ifx_GTM_ATOMx*)(volatile void *)(MODULE_GTM.ATOM)).\
          ATOM_CH[ModuleNo].CH[ChannelNo].CM1.U)));
}
 ...
 defined in header files*/
{
  ...
  ((*(Ifx_GTM_TOMx*)(volatile void *)(MODULE_GTM.TOM)).TOM_CH[ModuleNo].\
                         CH[ChannelNo].SR0.U) = (unsigned_int)Sr0Value;
...
{
  ((*(Ifx_GTM_ATOMx*)(volatile void *)(MODULE_GTM.ATOM)).ATOM_CH[ModuleNo]. \
               CH[ChannelNo].SR0.U) = (unsigned_int)(Sr0Value & GTM_TIMER_MASK);
}
 ...
 defined in header files*/
{
  ...
  ((*(Ifx_GTM_TOMx*)(volatile void *)(MODULE_GTM.TOM)).TOM_CH[ModuleNo].\
                                CH[ChannelNo].SR1.U) = (unsigned_int)Sr1Value;
...
{
  (*(Ifx_GTM_ATOMx*)(volatile void *)(MODULE_GTM.ATOM)).ATOM_CH[ModuleNo].\
                CH[ChannelNo].SR1.U = (unsigned_int)(Sr1Value & GTM_TIMER_MASK);
}
...
{
  /* Returns the OUT bit of the channel Status register */
  return((Gtm_OutputLevelType)((*(Ifx_GTM_ATOMx*)(volatile void *)\
     (MODULE_GTM.ATOM)).ATOM_CH[ModuleNo].CH[ChannelNo].STAT.U & GTM_BIT_SET));
}
 ...
 defined in header files*/
{
  ...
  return((uint32)(*(Ifx_GTM_TIMx*)(volatile void *)(MODULE_GTM.TIM)).\
...
{
  Mcal_SetAtomic(
  (sint32*)&((*(Ifx_GTM_TIMx*)(volatile void *)(MODULE_GTM.TIM)).\
  CH_TIM[ModuleNo].CH[ChannelNo].CH_TDUV), (sint32)(TimeOutDuration), \
  (sint32)GTM_TIM_TDUV_POS, GTM_TIM_TDUV_SIZE);
...
{
  (*(Ifx_GTM_TIMx*)(volatile void *)(MODULE_GTM.TIM)).CH_TIM[ModuleNo].\
             CH[ChannelNo].CH_CTRL.U |= (unsigned_int)GTM_TIM_CH_TO_EN_BIT;
...
{
  (*(Ifx_GTM_TIMx*)(volatile void *)(MODULE_GTM.TIM)).CH_TIM[ModuleNo].\
  CH[ChannelNo]. CH_CTRL.U &=(unsigned_int)(GTM_TIM_TO_BIT_RESET);
}
    ...
    )
{
 ...
 defined in header files*/
  uint32 RegVal;
  RegVal =  (*(Ifx_GTM_TIMx*)(volatile void *)(MODULE_GTM.TIM)).\
                                      CH_TIM[ModuleNo].CH[ChannelNo].CH_TDUV.U;
  RegVal &= ~GTM_TIM_TCS_MASK;
  RegVal |= ((uint32)ClockSource) << GTM_TIM_TCS_POS;

  (*(Ifx_GTM_TIMx*)(volatile void *)(MODULE_GTM.TIM)).CH_TIM[ModuleNo].\
  CH[ChannelNo].CH_TDUV.U = (unsigned_int)RegVal;
}
 ...
 defined in header files*/
{
  ...
  return((uint8)(((*(Ifx_GTM_TIMx*)(volatile void *)(MODULE_GTM.TIM)).    \
 ...
 defined in header files*/
{
  ...
  ((Gtm_BrcType*)(volatile void *)&(MODULE_GTM.BRC))->BrcSrc[SourceNo].\
                                           SRC_DEST.U = (unsigned_int)SelDest;
}
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
  ...
  if(TbuChannelNo < GTM_NO_OF_TBU_CHANNELS)
  {
    ...
    if(Mcal_Extract(GTM_TBU_CHEN.U, ChannelPos, 2U) > 0U)
    {
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
  ...
  Permitted for special function registers.*/
    RetVal =(((Gtm_TbuType*)(volatile void *)&(MODULE_GTM.TBU))->\
 ...
 defined in header files*/
{
  if(ChannelNo < GTM_TOM_TGC0_CHOSEN)
  {
    (*(Ifx_GTM_TOMx*)(volatile void *)(MODULE_GTM.TOM)).TOM_TGC[ModuleNo].\
                                               TGC[GTM_TGC0].ENDIS_STAT.U =   \
   (unsigned_int)(GTM_TOM_CHAN_DISABLE << (GTM_TOM_BITS_PER_CHAN * ChannelNo));
  }
  else if(ChannelNo < GTM_TOM_TGC1_CHOSEN)
  {
    (*(Ifx_GTM_TOMx*)(volatile void *)(MODULE_GTM.TOM)).TOM_TGC[ModuleNo].\
 ...
 defined in header files*/
{
   ...
   AGC_GLB_CTRL.U |=   (unsigned_int)(GTM_ATOM_ENABLE << \
 ...
 defined in header files*/
{
  ...
  if(ChannelNo < GTM_CHANNELS_PER_ATOM_MODULE)
  {
    MODULE_GTM.ATOM[ModuleNo].AGC.ENDIS_STAT.U =    \
     (unsigned_int)(GTM_ATOM_ENABLE << (GTM_ATOM_BITS_PER_CHAN * ChannelNo));
  }
}
 ...
 defined in header files*/
{
  if(ChannelNo < GTM_CHANNELS_PER_ATOM_MODULE)
  {
    MODULE_GTM.ATOM[ModuleNo].AGC.ENDIS_STAT.U = (unsigned_int)\
 ...
 defined in header files*/
{
  ...
  (*(Ifx_GTM_AFDx*)(volatile void *) (&MODULE_GTM)).AFD_MODULE[ FifoModuleNo].\
                 AFD.CH[FifoChannel].BUF_ACC.U = (unsigned_int)Entry;
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
{
  return((uint32)((*(Ifx_GTM_AFDx*)(volatile void *) (&MODULE_GTM)).\
                      AFD_MODULE[FifoModuleNo].AFD.CH[FifoChannel].BUF_ACC.U));
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
{
  GTM_DPLL_CTRL_1.U |= (unsigned_int)(GTM_BIT_SET << GTM_DPLL_DEN_POS);
}
 ...
 defined in header files*/
{
  if ((TimerModule == GTM_TOM) && (GroupNo < GTM_NO_OF_TGC_PER_MODULE))
  {
      ((*(Ifx_GTM_TOMx*)(volatile void *)(MODULE_GTM.TOM)).TOM_TGC[ModuleNo].\
                                   ...
                                   (unsigned_int)(1UL << GTM_ACTTB_TBTRIG_POS);
  }
 ...
 defined in header files*/
{
  ...
  FltValuePtr->FltRisingEdge  = ((*(Ifx_GTM_TIMx*) (volatile void *)\
                 (MODULE_GTM.TIM)).CH_TIM[ModuleNo].CH[ChannelNo].CH_FLT_RE.U);
  FltValuePtr->FltFallingEdge = ((*(Ifx_GTM_TIMx*)(volatile void *)\
 ...
 defined in header files*/
{
  ...
  FIFO.CH[FifoChannelNo].CTRL.U |= (unsigned_int)(1UL << GTM_FIFO_FLUSH_POS);
}
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
  ...
  (*(Ifx_GTM_F2Ax*)(volatile void *) (&MODULE_GTM)).\
  F2A_MODULE[ FifoModuleNo].F2A.ENABLE.U= (unsigned_int)\
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
{
  MODULE_GTM.MCS[McsModule].CTRL.U |= (unsigned_int)(1UL << GTM_MCS_RAMRST_POS);
}
 ...
 defined in header files*/
{
  if(TriggerCtrl == TRUE)
  {
    MODULE_GTM.MCS[McsModule].CH0.STRG.U |= (unsigned_int)(1UL << TriggerNo);
  }
  else
  {
    MODULE_GTM.MCS[McsModule].CH0.CTRG.U |= (unsigned_int)(1UL << TriggerNo);
  }
}
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
{
  GTM_DPLL_CTRL_1.U |= (unsigned_int)(GTM_BIT_SET << GTM_DPLL_SWR_POS);
}
 ...
 defined in header files*/
{
  if(RefMode == 1U)
  {
    GTM_DPLL_CTRL_0.U |= (unsigned_int)(1UL << GTM_DPLL_RMO_POS);
  }
  else
  {
    GTM_DPLL_CTRL_0.U &= (unsigned_int)(~(1UL << GTM_DPLL_RMO_POS));
 ...
 defined in header files*/
{
  if(ToEnable == 1U)
  {
    MODULE_GTM.SPE[ModuleNo].CTRL_STAT.U |= (unsigned_int)1UL;
  }
  else
  {
    MODULE_GTM.SPE[ModuleNo].CTRL_STAT.U &= (unsigned_int)~(1UL);
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
  ...
  RetVal = MODULE_GTM.SPE[ModuleNo].CTRL_STAT.U;
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
{
  GTM_MAP_CTRL.U = (unsigned_int)MapInput;
}
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
{
  return((uint8)((*(Ifx_GTM_FIFOx*)(volatile void *)\
  (&MODULE_GTM)).FIFO_MODULE[ FifoModuleNo].FIFO.CH[FifoChannelNo].STATUS.U));
}
 ...
 defined in header files*/
  ...
  if(Gtm_GetMcsRamRstStat(McsModNo) == FALSE)
  {
    if(Activity == 1UL)
    {
      ...
      CH_MCS[McsModNo].CH[McsChannel].CH_CTRL.U) |= (unsigned_int)1UL;
    }
    else
    {
       ((*(Ifx_GTM_MCSx*)(volatile void *)(MODULE_GTM.MCS)). \
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
  ...
  /* Check if the channel is disabled */
    if(((((*(Ifx_GTM_MCSx*)(volatile void *)(MODULE_GTM.MCS)).\
      CH_MCS[McsModNo].CH[McsChannel].CH_CTRL.U) & \
      GTM_MCS_CHCTRL_EN_MASK) == 0U))
  {
    ...
    ((*(Ifx_GTM_MCSx*)(volatile void *)(MODULE_GTM.MCS)).CH_MCS[McsModNo]. \
                               CH[McsChannel].CH_PC.U) = (unsigned_int)PcValue;
    RetVal = TRUE;
  }
  return(RetVal);
 ...
 defined in header files*/
{
  ...
  ((*(Ifx_GTM_MCSx*)(volatile void *)(MODULE_GTM.MCS)).CH_MCS[McsModNo].\
       CH[McsChannel].CH_IRQ_FORCINT.U) |= (unsigned_int)(1UL << IntrptToTrig);
}
 ...
 defined in header files*/
{
  ...
  {
    ((*(Ifx_GTM_MCSx*)(volatile void *)(MODULE_GTM.MCS)).CH_MCS[McsModNo].\
          CH[McsChannel].CH_IRQ_EN.U) |= (unsigned_int)(1UL << IntrptToCtrl);
  }
 ...
 defined in header files*/
{
  ...
  MODULE_GTM.MCS[McsModNo].RST.U = (unsigned_int)ResetVal;
}
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
 defined in header files*/
  ...
  RetVal |= (uint32)(MODULE_GTM.MCS[McsModNo].ERR.U << GTM_UPPER_HALFWORD);
 ...
 defined in header files*/
{
  ...
  GTM_DPLL_RAM_INI.U |= (unsigned_int)GTM_DPLL_RAMRST_MASK;
}
